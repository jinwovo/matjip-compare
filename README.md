...
- **영업중 여부 · 영업시간** — 지금 영업 중인지 표시하고 영업시간 안내
- **리뷰 · 사진** — 상세 카드에 플랫폼별 대표 리뷰 스니펫 + 사진 갤러리
- **길찾기** — 카카오맵 · 네이버지도 · 구글맵 원터치 길찾기 (모바일은 앱으로)
- **정렬 · 필터** — 추천·평점·리뷰·가까운순 + `지금`(영업중·가까운·고평점), 별점/리뷰 최소 필터
- **마커 클러스터링 · 즐겨찾기 · PWA** — 코드 한 벌로 모바일·데스크톱, 홈 화면 설치 지원
